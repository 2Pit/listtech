...
pub struct SearchHit {
    #[prost(message, repeated, tag = "1")]
    pub fields: ::prost::alloc::vec::Vec<SearchField>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SearchField {
    #[prost(string, tag = "1")]
    pub name: ::prost::alloc::string::String,
    #[prost(oneof = "search_field::Value", tags = "2, 3, 4, 5, 6, 7, 8, 9")]
    pub value: ::core::option::Option<search_field::Value>,
}
/// Nested message and enum types in `SearchField`.
...
pub struct SearchMatrixResponse {
    ...
    pub columns: ::prost::alloc::vec::Vec<ColumnVector>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ColumnVector {
    #[prost(string, tag = "1")]
    pub name: ::prost::alloc::string::String,
    #[prost(oneof = "column_vector::Values", tags = "2, 3, 4, 5, 6, 7, 8, 9")]
    pub values: ::core::option::Option<column_vector::Values>,
}
/// Nested message and enum types in `ColumnVector`.
...
pub struct BoolColumn {
    #[prost(message, repeated, tag = "1")]
    pub values: ::prost::alloc::vec::Vec<super::google::protobuf::BoolValue>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Int64Column {
    #[prost(message, repeated, tag = "1")]
    pub values: ::prost::alloc::vec::Vec<super::google::protobuf::Int64Value>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UInt64Column {
    #[prost(message, repeated, tag = "1")]
    pub values: ::prost::alloc::vec::Vec<super::google::protobuf::UInt64Value>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DoubleColumn {
    #[prost(message, repeated, tag = "1")]
    pub values: ::prost::alloc::vec::Vec<super::google::protobuf::DoubleValue>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StringColumn {
    #[prost(message, repeated, tag = "1")]
    pub values: ::prost::alloc::vec::Vec<super::google::protobuf::StringValue>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BytesColumn {
    #[prost(message, repeated, tag = "1")]
    pub values: ::prost::alloc::vec::Vec<super::google::protobuf::BytesValue>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct FacetColumn {
    #[prost(message, repeated, tag = "1")]
    pub values: ::prost::alloc::vec::Vec<FacetWrapper>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct FacetWrapper {
    #[prost(string, repeated, tag = "1")]
...
pub mod search_service_server {
    ...
    pub const SERVICE_NAME: &str = "searcher.SearchService";
