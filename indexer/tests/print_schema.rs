// use indexer::api;
// use indexer::infra::schema::{MetaColumn, Schema};
...
//     let columns: Vec<MetaColumn> = field_descriptions
//         .iter()
//         .enumerate()
//         .map(|(i, (name, col_type))| MetaColumn {
//             tan_field: TanField::from_field_id(i as u32),
//             column_type: col_type.clone(),
//             name: name.to_string(),
//             is_id: true,
//             is_eq: false,
//             is_sort_range: matches!(col_type, api::ColumnType::Double | api::ColumnType::Ulong),
